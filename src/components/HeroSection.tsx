...
export function HeroSection() {
  return (
    <div className="relative min-h-screen">
      ...
      {/* Shadow Transition */}
      <div className="absolute -bottom-24 left-0 right-0 h-24 bg-gradient-to-b from-transparent to-white/20"></div>
      ...
      <div className="relative z-10 container mx-auto px-4 min-h-screen flex flex-col items-center justify-center text-center pt-20">
        ...
        <div className="mb-8 animate-float">
          <img
            ...
            alt="Rouge's Storybook World - A magical world of stories and imagination"
            className="w-32 h-32 md:w-40 md:h-40 object-contain drop-shadow-2xl"
          />
        </div>

        {/* Hero Text */}
        <h1 className="font-enchanted text-4xl sm:text-5xl md:text-7xl font-bold mb-6 pb-1 text-transparent bg-clip-text bg-gradient-to-r from-white to-white/90 leading-tight animate-fade-in drop-shadow-[0_2px_10px_rgba(255,255,255,0.3)]">
        ...
        <p className="font-sans text-lg sm:text-xl md:text-2xl text-white/90 mb-8 max-w-3xl animate-fade-in-delay drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]">
          Let every page turn transport you to a realm of magic and wonder, where enchanting audiobooks and paperbacks bring stories to life.
        </p>
        ...
        <a 
          ...
          className="bg-gradient-to-r from-amber-500 to-amber-400 hover:from-amber-400 hover:to-amber-500 text-white text-xl px-8 py-4 rounded-full shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl hover:ring-2 hover:ring-amber-300/50 mb-8 animate-fade-in-delay-2"
        >
          Browse Books
        </a>
