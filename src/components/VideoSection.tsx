 ...
 * VideoSection.tsx
 * ------------------
 * Embeds a YouTube video with a section header, testimonial, and CTA link.
...
export function VideoSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-24 left-0 right-0 h-24 bg-gradient-to-b from-transparent to-purple-500/20" />

      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto">
          {/* Section Header */}
          <div className="text-center mb-12 opacity-0 animate-fade-in">
            <h2 className="font-enchanted text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-white drop-shadow-md">
          ...
          <div className="text-center opacity-0 animate-fade-in-delay-3">
            <a
              ...
              className="inline-flex items-center space-x-2 bg-gradient-to-r from-amber-500 to-amber-400 hover:from-amber-400 hover:to-amber-500 text-white text-xl px-8 py-4 rounded-full shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl"
            >
